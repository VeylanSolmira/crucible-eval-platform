#!/usr/bin/env python3
"""
Docker Compose service resilience chaos testing.

Tests the platform's ability to handle service restarts, failures,
and recovery scenarios in Docker Compose deployments.

These tests are marked as 'destructive' because they stop and restart services.
Run with: pytest -m destructive tests/chaos/docker/test_service_resilience.py
"""
...
pytestmark = [pytest.mark.chaos, pytest.mark.destructive, pytest.mark.docker]
