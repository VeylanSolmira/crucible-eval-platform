...
@pytest.mark.skipif(
    os.getenv("SKIP_NETWORK_ISOLATION", "false").lower() == "true",
    reason="Network isolation tests skipped in development (Kind uses kindnet CNI without NetworkPolicy support)"
)
