"""
Integration tests for Celery priority queue functionality.
...
3. The priority queue system is working as expected
"""
...
def celery_client():
    ...
    celery_app = Celery("test_client", broker="redis://localhost:6379/0")
