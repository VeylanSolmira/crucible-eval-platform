  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Documentation Page Not Found</h1>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
        ...
        <div className="space-y-2">
          <p className="text-blue-800">
            • Check the{' '}
            <Link href="/docs" className="font-medium underline hover:no-underline">
              documentation index
            </Link>{' '}
          ...
          <p className="text-blue-800">
            • Browse our{' '}
            <Link href="/docs/quickstart" className="font-medium underline hover:no-underline">
              quickstart guide
            </Link>{' '}
            to get started
          </p>
          <p className="text-blue-800">
            • View the{' '}
            <Link href="/docs/architecture" className="font-medium underline hover:no-underline">
      ...
      <div className="bg-gray-100 rounded-lg p-6 mb-8">
        <h3 className="font-medium text-gray-900 mb-2">📝 Note about Wiki Links</h3>
        <p className="text-gray-700 text-sm">
          If you arrived here from a wiki link [[like this]], the page might not have been created
          yet. Wiki links are automatically detected but the target pages need to be manually
          created.
        </p>
      </div>
