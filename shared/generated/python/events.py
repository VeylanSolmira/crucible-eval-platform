...
class EvaluationQueuedEvent(BaseModel):
    ...
    language: Optional[str] = Field(
        default="python", description="Programming language (currently only python supported)"
    )
    metadata: Optional[Dict[str, Any]] = Field(
        default=None, description="Additional metadata for the evaluation"
    )
...
class EvaluationFailedEvent(BaseModel):
    ...
    executor_id: Optional[str] = Field(
        default=None, description="ID of executor if failure occurred during execution"
    )
