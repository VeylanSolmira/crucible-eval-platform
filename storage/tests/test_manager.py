...
class TestFlexibleStorageManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.manager = FlexibleStorageManager(
            primary_storage=self.primary,
            fallback_storage=self.fallback,
    ...
    def test_fallback_on_primary_failure(self):
        ...
        result = self.run_async(
            manager.create_evaluation(eval_id, code)
        )
        self.assertTrue(result)
    ...
    def test_list_evaluations_with_filter(self):
        ...
        completed = self.run_async(
            self.manager.list_evaluations(status='completed')
        )
