...
def upgrade() -> None:
    ...
    op.add_column(
        "evaluations", sa.Column("output_truncated", sa.Boolean(), nullable=True, default=False)
    )
    op.add_column(
        "evaluations", sa.Column("error_truncated", sa.Boolean(), nullable=True, default=False)
    )
