...
class StorageManager:
    ...
    async def create_evaluation(self, eval_id: str, code: str) -> Evaluation:
        ...
        evaluation = Evaluation(
            ...
            metadata={"code_lines": len(code.splitlines()), "code_size": len(code)},
        )
    ...
    async def update_evaluation_status(
        self, eval_id: str, status: str, **kwargs
    ) -> Optional[Evaluation]:
        """
    ...
    async def add_evaluation_event(
        self, eval_id: str, event_type: str, message: str, metadata: Optional[Dict[str, Any]] = None
        ...
        event = EvaluationEvent(
            evaluation_id=eval_id, event_type=event_type, message=message, metadata=metadata or {}
        )
    ...
    async def add_evaluation_metric(
        self, eval_id: str, metric_name: str, metric_value: float, unit: Optional[str] = None
        ...
        metric = EvaluationMetric(
            evaluation_id=eval_id, metric_name=metric_name, metric_value=metric_value, unit=unit
        )
